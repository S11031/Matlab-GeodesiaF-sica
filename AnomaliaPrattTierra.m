function [AnomaliaPratt] = AnomaliaPrattTierra(Altura,NivelCompensancion,Latitud,GravedadObservada)
%Datos del sitio
...
P2=(P0*NivelCompensancion)/(NivelCompensancion+Altura)
...
b=NivelCompensancion
c=NivelCompensancion+Altura
...
AnomaliaPratt=GravedadObservada+0.308*Altura-0.1119*Altura+CIPM-GTEORICA
